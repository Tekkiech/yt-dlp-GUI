...
// Global default variables for huh pointers
var (
...
func (m model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.WindowSizeMsg:
		...
		m.logViewport.Height = m.height - 14 // Adjusted for more UI elements
		m.refreshViewport()
	...
	case doneMsg:
		...
		notifySound() // Trigger sound on completion
		if msg.err != nil {
...
func runYtDlpCmd(url, quality string, merge bool, dir string) tea.Cmd {
	return func() tea.Msg {
		...
		// -P flag sets the download path in yt-dlp
